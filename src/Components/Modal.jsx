...
import OC_background from "./OC_Backdrop";
import WakeupTable from "./WakeupTable";
...
const Modal = ({handleClose, mode, timeInput}) =>{
    return(
        <OC_background onClick={handleClose}>
            <motion.div
